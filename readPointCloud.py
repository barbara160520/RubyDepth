...
def readPointDataAndTransformAngles_mod_colors(num):
    pd_filename = f"./points/chear_in_490/point_{num}.txt"
    t_filename = f"./points/chear_in_490/t_{num}.txt"
    r_filename = f"./points/chear_in_490/r_{num}.txt"
    c_filename = f"./points/chear_in_490/colors_{num}.txt"
